...
describe('PasswordResetView.vue', () => {
  ...
  afterEach(() => {
   ...
   it('should set message on successful password reset', async () => {
    ...
    mock.onPost(`${import.meta.env.VITE_API_URL}/api/password-reset`).reply(200, mockSuccessResponse)
  ...
  it('should set message on failed password reset', async () => {
    ...
    mock.onPost(`${import.meta.env.VITE_API_URL}/api/password-reset`).reply(400, mockErrorResponse)
