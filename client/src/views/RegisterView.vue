          ...
          <form method="POST" @submit.prevent="registerUser">
            ...
            <div class="space-y-6">
              ...
              <div v-if="!showRegisterForm" class="flex flex-wrap items-center justify-between gap-4 mt-6">
                <div>
                  <a href="javascript:void(0);" class="text-green-600 font-semibold text-sm hover:underline">
                    Forgot Password?
                  </a>
                </div>
              </div>
      ...
      <div class="bg-white p-8 pb-3 rounded-md max-w-4xl w-full max-h-full">
        ...
        <div class="max-h-96 overflow-y-auto" id="tos-text">
          ...
          <ul>
            ...
            <li>
              <p><strong>Website</strong> refers to Social Backgammon, accessible from <a href="backgammon.hopto.org"
                                                                                          rel="external nofollow noopener"
                                                                                          target="_blank">backgammon.hopto.org</a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>By visiting this page on our website: <a href="backgammon.hopto.org" rel="external nofollow noopener"
                                                         target="_blank">backgammon.hopto.org</a></li>
          </ul>
        </div>
        <div class="flex justify-center items-center">
          <button @click="toggleTerms" class="px-4 py-2 mt-3 bg-gray-700 text-white rounded-md hover:bg-gray-800">Close
          </button>
        </div>
      </div>
    </div>
