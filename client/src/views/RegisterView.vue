<template>
  <div class="font-[sans-serif] bg-gray-50 flex items-center md:h-screen p-4">
    <div class="w-full max-w-4xl max-md:max-w-xl mx-auto">
      <div
        class="grid md:grid-cols-2 gap-16 w-full sm:p-8 p-6 shadow-md rounded-md overflow-hidden pl-3 py-2 bg-gray-600 text-white shadow-md">
        <div class="max-md:order-1 space-y-6">
          <div class="md:mb-16 mb-8">
            <h3 class="text-2xl font-bold">Social Login</h3>
          </div>
          ...
          <div class="space-y-6">
            <button type="button"
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="22px" fill="#fff" class="inline shrink-0 mr-4"
        ...
        <form class="w-full" method="POST" @submit.prevent="registerUser">
          <div class="mb-8">
            <h3 class="text-2xl font-bold">{{ showRegisterForm ? 'Register' : 'Login' }}</h3>
          </div>
          ...
          <div class="space-y-6">
            ...
            <div>
              <label class="text-sm mb-2 block">Password
                <div class="relative flex items-center">
                  ...
                  <svg v-if="!showPassword" @click="togglePasswordVisibility" xmlns="http://www.w3.org/2000/svg"
                       fill="#bbb" stroke="#bbb" class="w-4 h-4 absolute right-4 cursor-pointer" viewBox="0 0 128 128">
                    <path
                      d="M64 104C22.127 104 1.367 67.496.504 65.943a4 4 0 0 1 0-3.887C1.367 60.504 22.127 24 64 24s62.633 36.504 63.496 38.057a4 4 0 0 1 0 3.887C126.633 67.496 105.873 104 64 104zM8.707 63.994C13.465 71.205 32.146 96 64 96c31.955 0 50.553-24.775 55.293-31.994C114.535 56.795 95.854 32 64 32 32.045 32 13.447 56.775 8.707 63.994zM64 88c-13.234 0-24-10.766-24-24s10.766-24 24-24 24 10.766 24 24-10.766 24-24 24zm0-40c-8.822 0-16 7.178-16 16s7.178 16 16 16 16-7.178 16-16-7.178-16-16-16z"
                      data-original="#000000"></path>
                  </svg>
                  <svg v-else @click="togglePasswordVisibility" xmlns="http://www.w3.org/2000/svg" fill="#bbb"
                       stroke="#bbb" class="w-4 h-4 absolute right-4 cursor-pointer" viewBox="0 0 24 24">
                    <path
            ...
            <div v-if="showRegisterForm" class="flex items-center">
              ...
              <label for="tos" class="ml-3 block text-sm">
                I accept the <a @click="toggleTerms" class="text-green-600 font-semibold hover:underline ml-1">Terms and
                Conditions</a>
              </label>
            </div>
          ...
          <p v-if="showRegisterForm" class="text-sm mt-6 text-center">Already have an account? <a
            class="text-green-600 font-semibold hover:underline ml-1 register-login-switch"
            @click="toggleRegisterLogin">Login</a></p>
          <p v-else class="text-sm mt-6 text-center">Don't have an account? <a
            class="text-green-600 font-semibold hover:underline ml-1 register-login-switch"
    ...
    <div v-if="showTerms" class="fixed inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center z-50 p-4">
      <div class="bg-white p-8 rounded-md max-w-4xl w-full max-h-full">
        ...
        <div class="max-h-96 overflow-y-auto" id="tos-text">
          ...
          <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the
            ...
            created with the help of the <a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank">Privacy
          ...
          <ul>
            ...
            <li>
              <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                or &quot;Our&quot; in this Agreement) refers to Social Backgammon.</p>
            </li>
            <li>
            ...
            <li>
              <p><strong>Website</strong> refers to Social Backgammon, accessible from <a href="PLACEHOLDER_URL"
                                                                                          rel="external nofollow noopener"
                                                                                          target="_blank">PLACEHOLDER_URL</a>
              </p>
            </li>
            <li>
          ...
          <p>If You decide to register through or otherwise grant us access to a Third-Party Social Media Service, We
            ...
            such as Your name, Your email address, Your activities or Your contact list associated with that
            account.</p>
          ...
          <ul>
            <li>By visiting this page on our website: <a href="PLACEHOLDER_URL/contact" rel="external nofollow noopener"
                                                         target="_blank">PLACEHOLDER_URL/contact</a></li>
          </ul>
        </div>
        <button @click="toggleTerms" class="px-4 py-2 bg-gray-700 text-white rounded-md hover:bg-gray-800">Close
        </button>
      </div>
    </div>
  </div>
