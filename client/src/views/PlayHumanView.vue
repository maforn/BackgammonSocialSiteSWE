<template>
	<div class="play-human-view">
			...
			>
				...
				<div class="flex justify-center">
					<button
						...
						@click="sendInvite"
						class="mt-2 px-4 py-2 w-2/3 rounded-xl"
					>
						Invite
					</button>
				</div>
		...
		<button @click="goHome" class="absolute top-4 left-4 px-4 py-2 bg-white text-black rounded-md hover:bg-gray-400">
			<v-icon name="io-home-sharp" />
		</button>
	</div>
</template>
